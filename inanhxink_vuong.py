...
def create_image_collage(input_folder, output_file="output_collage.jpg", cols=5, rows=2, 
    ...
    for idx, img_path in enumerate(image_files):
        ...
        try:
            ...
            # Just detect for logging purposes
            ...
            # Cell is square, so both dimensions are the same
...
def main():
    ...
    output_folder = "output_images_vuong"
    ...
    for idx, subfolder_name in enumerate(sorted(subfolders), 1):
        ...
        # Create the collage with SQUARE cells
        cell_size = 1050  # Square cell size
        create_image_collage(
            input_folder=subfolder_path,
            output_file=output_file,
            cols=cols,
            rows=rows,
            border_width=5,  # Border for very high resolution
            border_color=(0, 0, 0),
            img_width=cell_size,  # Square cells
            img_height=cell_size,  # Square cells
